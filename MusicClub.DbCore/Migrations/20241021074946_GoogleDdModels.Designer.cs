...
namespace MusicClub.DbCore.Migrations
{
    ...
    [Migration("20241021074946_GoogleDdModels")]
    partial class GoogleDdModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicClub.DbCore.Models.GoogleCalendar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MusicClub.DbCore.Models.GoogleEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MusicClub.DbCore.Models.Act", b =>
                {
                    b.HasOne("MusicClub.DbCore.Models.GoogleEvent", "GoogleEvent")
                        .WithOne("Act")
                        .HasForeignKey("MusicClub.DbCore.Models.Act", "GoogleEventId")
            ...
            modelBuilder.Entity("MusicClub.DbCore.Models.GoogleEvent", b =>
                {
                    b.HasOne("MusicClub.DbCore.Models.GoogleCalendar", "GoogleCalendar")
